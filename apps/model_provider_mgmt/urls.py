...
from apps.model_provider_mgmt.views.llm_view import LLMModelViewSet, LLMViewSet, SkillRequestLogViewSet
...
router.register(r"skill_log", SkillRequestLogViewSet)
